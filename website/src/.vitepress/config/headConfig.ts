...
const headConfig: HeadConfig[] = [
  ...
  // ['meta', { name: 'twitter:site', content: '@sxs-eternity' }],
  // ['meta', { name: 'twitter:creator', content: '@sxs-eternity' }],
  ['meta', { property: 'og:site_name', content: 'Eternity' }],
  ['meta', { property: 'og:description', content: 'Easier access to the information you need, written clearly.' }],
