...
const themeConfig: DefaultTheme.Config = {
  ...
  socialLinks: [
    {
      icon: 'github',
      link: 'https://github.com/sxs-eternity/sxs-eternity.github.io',
    ...
    //   },
    //   link: 'https://reddit.com/r/sxs-eternity',
    //   ariaLabel: 'Support subreddit',
    // },
    // { icon: "instagram", link: "https://instagram.com/sxs-eternity", ariaLabel: "Instagram Page" },
  ],
  ...
  footer: {
    ...
    copyright: `Copyright © ${new Date().getFullYear()} Eternity Guild`,
  },

  editLink: {
    pattern: 'https://github.com/sxs-eternity/sxs-eternity.github.io/edit/main/website/src/:path',
